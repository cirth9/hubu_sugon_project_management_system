...
func (r *Resolver) Build(target resolver.Target, cc resolver.ClientConn, opts resolver.BuildOptions) (resolver.Resolver, error) {
	r.cc = cc
	zap.S().Info("\ntarget:\n", target.Endpoint(), "\n", target.String())
	//Name: target.Endpoint, Version: target.Authority

	//解析version
	grpcUrl := target.String()
	...
	r.keyPrifix = BuildPrefix(Server{Name: target.Endpoint(), Version: version})
	zap.S().Info("resolver build key prefix: \n", r.keyPrifix)
